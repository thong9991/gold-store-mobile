          ...
          case 404:
            return Failure(
                ...
                error.response?.data["error"] ??
                    error.response?.data["message"]);
          case 422:
            return DataSource.UNPROCESSABLE_REQUEST.getFailure();
          case 500:
...
extension DataSourceExtension on DataSource {
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.UNPROCESSABLE_REQUEST:
        return Failure(ResponseCode.UNPROCESSABLE_REQUEST,
            ResponseMessage.UNPROCESSABLE_REQUEST);
...
class ResponseCode {
  ...
  static const int UNPROCESSABLE_REQUEST = 422; // failure, API rejected request
...
class ResponseMessage {
  ...
  static const String UNPROCESSABLE_REQUEST =
      AppStrings.strUnprocessableRequestError; // failure, lost required fields
